...
export default function App() {
  ...
  const agregarFavorito = (producto: any) => {
  ...
  return (
    ...
    >
      <nav className="sticky top-0 z-50 backdrop-blur-2xl bg-white/70 dark:bg-neutral-900/70 border-b border-white/20 shadow-xl">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-4">
            ...
            <button
              onClick={() => setAbrirFavoritos(true)}
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-5 rounded-full shadow-2xl animate-bounce transition duration-300 hover:scale-110"
      >
        💬
      </a>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="mb-10">
          <input
            ...
            className={`w-full px-6 py-5 rounded-3xl border shadow-xl transition-all duration-500 ${
              darkMode
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <button
              onClick={() => setBusqueda("")}
              className="px-5 py-2 rounded-full bg-emerald-700 text-white font-bold"
            >
              Todos
            </button>

            <button
              onClick={() => setBusqueda("Boina")}
              className="px-5 py-2 rounded-full bg-white dark:bg-neutral-800 shadow font-bold"
            >
              Boinas
            </button>

            <button
              onClick={() => setBusqueda("Gorro")}
              className="px-5 py-2 rounded-full bg-white dark:bg-neutral-800 shadow font-bold"
            >
              Gorros
            </button>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="bg-white/60 dark:bg-neutral-900/70 backdrop-blur-xl rounded-[40px] shadow-2xl p-10">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-neutral-800 rounded-3xl p-6 shadow-lg hover:scale-105 transition">
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-3xl p-6 shadow-lg hover:scale-105 transition">
              ...
              <p>
                Se aceptan devoluciones únicamente si el producto está limpio, en buen estado y explicando claramente el motivo.
              </p>
            </div>

            <div className="bg-white dark:bg-neutral-800 rounded-3xl p-6 shadow-lg border border-red-200 md:col-span-2 hover:scale-105 transition">
              <h3 className="text-2xl font-bold mb-3">
                ⚠️ Garantía
              </h3>
        ...
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex justify-end">
          ...
          >
            <div className="flex items-center justify-between mb-8">
              ...
              <button
                onClick={() => setAbrirFavoritos(false)}
                className="text-3xl"
              >
                ✕
              </button>
